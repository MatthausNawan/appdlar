<?php namespace App\Http\Controllers;
	...
	class AdminTutoriais21Controller extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {
	    	# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->table 			   = "tutoriais";	        
			$this->title_field         = "id";
			$this->limit               = 20;
	        ...
	        $this->col = array();
			$this->col[] = array("label"=>"Titulo","name"=>"titulo" );
		$this->col[] = array("label"=>"Descricao","name"=>"descricao" );
