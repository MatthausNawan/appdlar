<?php namespace App\Http\Controllers;
	...
	class AdminAtividadesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Profissional","name"=>"profissional_id","join"=>"profissionais,nome"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nome','name'=>'nome','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Empregada doméstica;Babá;Governanta;Diarista;Faxineira;Cuidador de Idoso;Cuidadora;Passadeira;Copeira;Enfermeiro;Caseiro;'];
