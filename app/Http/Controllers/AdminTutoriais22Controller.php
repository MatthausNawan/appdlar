<?php namespace App\Http\Controllers;
	...
	class AdminTutoriais22Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'obs','name'=>'obs','type'=>'wysiwyg','validation'=>'required','width'=>'col-sm-9'];
